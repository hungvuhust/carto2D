...
public:
  Node(
      ...
      ::rclcpp::Node::SharedPtr node, bool collect_metrics);
  ~Node();
...
private:
  ...
  cartographer_ros_msgs::msg::StatusResponse
      FinishTrajectoryUnderLock(int trajectory_id)
  ...
  cartographer_ros_msgs::msg::StatusResponse TrajectoryStateToStatus(
      int trajectory_id,
      const std::set<cartographer::mapping::PoseGraphInterface::TrajectoryState>
          &valid_states);
  ...
  rclcpp::Publisher<cartographer_ros_msgs::msg::SubmapList>::SharedPtr
  ...
  ::rclcpp::Service<cartographer_ros_msgs::srv::SubmapQuery>::SharedPtr
      submap_query_server_;
  ::rclcpp::Service<cartographer_ros_msgs::srv::TrajectoryQuery>::SharedPtr
      trajectory_query_server;
  ::rclcpp::Service<cartographer_ros_msgs::srv::StartTrajectory>::SharedPtr
      start_trajectory_server_;
  ::rclcpp::Service<cartographer_ros_msgs::srv::FinishTrajectory>::SharedPtr
      finish_trajectory_server_;
  ::rclcpp::Service<cartographer_ros_msgs::srv::WriteState>::SharedPtr
      write_state_server_;
  ::rclcpp::Service<cartographer_ros_msgs::srv::GetTrajectoryStates>::SharedPtr
      get_trajectory_states_server_;
  ::rclcpp::Service<cartographer_ros_msgs::srv::ReadMetrics>::SharedPtr
  ...
  struct TrajectorySensorSamplers {
    TrajectorySensorSamplers(
        ...
        const double imu_sampling_ratio, const double landmark_sampling_ratio)

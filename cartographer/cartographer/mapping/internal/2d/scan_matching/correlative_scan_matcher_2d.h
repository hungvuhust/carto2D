...
struct SearchParameters {
  ...
  // For testing.
  SearchParameters(
      int num_linear_perturbations, int num_angular_perturbations,
...
struct Candidate2D {
  Candidate2D(
      const int init_scan_index, const int init_x_index_offset,
      const int init_y_index_offset, const SearchParameters &search_parameters)

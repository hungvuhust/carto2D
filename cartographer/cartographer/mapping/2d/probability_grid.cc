...
ProbabilityGrid::ProbabilityGrid(
    ...
    : Grid2D(
          limits, kMinCorrespondenceCost, kMaxCorrespondenceCost,
          conversion_tables),
...
void ProbabilityGrid::SetProbability(
    const Eigen::Array2i &cell_index, const float probability) {
...
bool ProbabilityGrid::ApplyLookupTable(

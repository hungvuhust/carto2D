...
public:
  ...
  MapBuilderInterface(int a) {
    std::cout << "MapBuilderInterface(int a) called" << std::endl;
  }
  ...
  // builder.
  virtual mapping::TrajectoryBuilderInterface *
  ...
  virtual bool SerializeStateToFile(
      bool include_unfinished_submaps, const std::string &filename)= 0;

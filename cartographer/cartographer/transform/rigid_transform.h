...
public:
  ...
  std::string DebugString() const {
    return absl::Substitute(
        "{ t: [$0, $1], r: [$2] }", translation().x(), translation().y(),
        rotation().angle());
  }
...
Rigid2<FloatType>
    operator*(const Rigid2<FloatType> &lhs, const Rigid2<FloatType> &rhs) {
...
std::ostream &operator<<(
    std::ostream &os, const cartographer::transform::Rigid2<T> &rigid) {
...
public:
  ...
  std::string DebugString() const {
    return absl::Substitute(
        "{ t: [$0, $1, $2], q: [$3, $4, $5, $6] }", translation().x(),
...
template <typename FloatType>
Rigid3<FloatType>
    operator*(const Rigid3<FloatType> &lhs, const Rigid3<FloatType> &rhs) {
...
template <typename T>
std::ostream &operator<<(
    std::ostream &os, const cartographer::transform::Rigid3<T> &rigid) {
  os << rigid.DebugString();
  return os;
}
